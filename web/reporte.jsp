            ...
            <div class="row g-3">
                ...
                <div class="col-2" style="background-color: #003366;">
                    ...
                    <div class="sidebar">
                        ...
                        <div class="suboption" onclick="redirectTo('reporte.jsp')" >Generar reporte</div>

                        <div class="option" onclick="toggleSuboptions(this)">
                            <i class="bi bi-caret-right-fill"></i> Configuracion
                        </div>

                        <div class="suboption" onclick="redirectTo('carrera.jsp')"> Carrera </div>
                ...
                <div class="col-10">
                    ...
                    <div class="content" id="content-area" ">
                        ...
                        <h1>Reporte de graficos </h1>  
                        <hr>
                        <canvas id="myChart" style="height: 15vh; width: 60vh; "></canvas>
                    </div>
                </div>
            </div>
        </div>
